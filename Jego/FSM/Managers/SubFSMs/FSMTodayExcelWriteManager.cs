...
namespace Jego.FSM.Managers.SubFSMs {
    public class FSMTodayExcelWriteManager : IFSMWriteExcelManager {
        private DateTime date;
        
        public FSMTodayExcelWriteManager(DateTime date) : base() {
            this.date = date;
        }
        ...
        public override void thread_DoWork(object sender, DoWorkEventArgs e) {
            ...
            DetailExcelTemplateCreator testTemplete = new DetailExcelTemplateCreator(1, getFilePath() + getFileName(), date, typeBaseDayModels, progressTransfer);
